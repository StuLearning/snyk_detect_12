module github.com/influxdata/influxdb/v2-v2.0.4

go 1.17

require github.com/influxdata/influxdb/v2 v2.0.4
...
require (
	...
	github.com/influxdata/flux v0.104.0 // indirect
	github.com/influxdata/pkg-config v0.2.6 // indirect
